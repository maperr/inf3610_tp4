...
{
 ModuleWrite_1TO0_590(0, SPACE_BLOCKING, &data);
}
...
{
 ModuleWrite_1TO6_600(6, SPACE_BLOCKING, &data);
}
...
{
 ModuleWrite_1TO4_610(4, SPACE_BLOCKING, &data);
}
...
{
 ModuleWrite_1TO2_620(2, SPACE_BLOCKING, &data);
}
...
void controller::sendMultiplicationMatOperand(unsigned long data)
{
 ...
 int status = Memory2Stream_22TO21_631(0x44000000,21, SPACE_BLOCKING, 500 * 500 * 4);
...
long controller::readAdditionResult()
{
 ...
 ModuleRead_1TO0_644(0, SPACE_BLOCKING, &data);
...
long controller::readSubtractionResult()
{
 ...
 ModuleRead_1TO6_658(6, SPACE_BLOCKING, &data);
...
long controller::readMultiplicationResult()
{
 ...
 ModuleRead_1TO4_672(4, SPACE_BLOCKING, &data);
...
long controller::readDivisionResult()
{
 ...
 ModuleRead_1TO2_686(2, SPACE_BLOCKING, &data);
...
{
 int status = Stream2Memory_21TO22_698(21, 0x44000000, SPACE_BLOCKING, 500 * 500 * 4);
}

...
#define DEBUGMODULE1_ID   23
#define DMA_XILINXBRAM1_MATRIX_MUL1_ID   25
#define ISSADAPTER1_ID   19
#define MATRIX_MUL1_MM2SFIFOIFPORT_ID   26
#define MATRIX_MUL1_S2MMFIFOIFPORT_ID   27
#define S_ARMCORTEXA91_HP0_AMBA_AXIBUS_LT1_ARMCORTEXA91_RANGE_ID   24
#define UART_ID   8
#define USERDEVICEEXTERNALIOSLAVE1_ID   9
#define USERDEVICEEXTERNALIOSLAVE2_ID   12
#define XILINXBRAM1_ID   22
#define XILINXPIC1_ID   20

// SpaceComponents PRIOs
#define ARMCORTEXA91_PRIO   1
#define DMA_XILINXBRAM1_MATRIX_MUL1_PRIO   11

// Memories' size
#define XILINXBRAM1_SIZE   0x1E84800

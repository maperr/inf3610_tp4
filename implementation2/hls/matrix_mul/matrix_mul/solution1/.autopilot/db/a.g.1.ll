; ModuleID = 'C:/Users/gabil/Documents/inf3610_tp4/implementation2/hls/matrix_mul/matrix_mul/solution1/.autopilot/db/a.g.1.bc'
...
bb2.i:                                            ; preds = %bb3.i
  ...
  call void (...)* @_ssdm_Unroll(i32 0, i32 0, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i32 0, i32 0)) nounwind, !dbg !2159
  ...
  call void @llvm.dbg.value(metadata !{i32 %sum.1}, i64 0, metadata !2160) nounwind, !dbg !2154
  %rend8.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str3, i32 0, i32 0), i32 %rbegin7.i) nounwind, !dbg !2161 ; <i32> [#uses=0]
  %k.1 = add i32 %k, 1, !dbg !2157                ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %k.1}, i64 0, metadata !2162) nounwind, !dbg !2157
  br label %bb3.i, !dbg !2157

bb3.i:                                            ; preds = %bb2.i, %bb1.i
  %k = phi i32 [ %k.1, %bb2.i ], [ 0, %bb1.i ]    ; <i32> [#uses=4]
  %sum = phi i32 [ %sum.1, %bb2.i ], [ 0, %bb1.i ] ; <i32> [#uses=2]
  call void @llvm.dbg.value(metadata !{i32 %k}, i64 0, metadata !2162) nounwind
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !2160) nounwind
...
bb4.i:                                            ; preds = %bb3.i
  ...
  %tmp.14 = add i32 %j, %tmp.7, !dbg !2163        ; <i32> [#uses=1]
  %this.addr.22 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 8, i32 %tmp.14, !dbg !2163 ; <i32*> [#uses=1]
  store i32 %sum.0.i.lcssa, i32* %this.addr.22, align 4, !dbg !2163
  %rend6.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str2, i32 0, i32 0), i32 %rbegin5.i) nounwind, !dbg !2164 ; <i32> [#uses=0]
  %j.1 = add i32 %j, 1, !dbg !2155                ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !2165) nounwind, !dbg !2155
  br label %bb5.i, !dbg !2155

bb5.i:                                            ; preds = %bb4.i, %bb.i
  %j = phi i32 [ %j.1, %bb4.i ], [ 0, %bb.i ]     ; <i32> [#uses=4]
  call void @llvm.dbg.value(metadata !{i32 %j}, i64 0, metadata !2165) nounwind
  %exitcond.i = icmp eq i32 %j, 300, !dbg !2155   ; <i1> [#uses=1]
  br i1 %exitcond.i, label %bb6.i, label %bb1.i, !dbg !2155

bb6.i:                                            ; preds = %bb5.i
  %rend.i = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([3 x i8]* @.str1, i32 0, i32 0), i32 %rbegin.i) nounwind, !dbg !2166 ; <i32> [#uses=0]
  %i.6 = add i32 %i.2, 1, !dbg !2167              ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %i.6}, i64 0, metadata !2168) nounwind, !dbg !2167
  br label %bb7.i, !dbg !2167

bb7.i:                                            ; preds = %bb6.i, %bb7.i.preheader
  %i.2 = phi i32 [ %i.6, %bb6.i ], [ 0, %bb7.i.preheader ] ; <i32> [#uses=3]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !2168) nounwind
  %exitcond4.i = icmp eq i32 %i.2, 300, !dbg !2167 ; <i1> [#uses=1]
  br i1 %exitcond4.i, label %multiplyMat.exit, label %bb.i, !dbg !2167

multiplyMat.exit:                                 ; preds = %bb7.i
  call void @llvm.dbg.value(metadata !{%struct.matrix_mul* %this}, i64 0, metadata !2169) nounwind
  %this.addr.19 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 8, i32 89999, !dbg !2170 ; <i32*> [#uses=1]
  %this.load = load i32* %this.addr.19, align 4, !dbg !2170 ; <i32> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %this.load) nounwind
  %ptData32.assign.5 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 8, i32 0, !dbg !2170 ; <i32*> [#uses=2]
  %this.load.1 = load i32* %ptData32.assign.5, align 4, !dbg !2170 ; <i32> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %this.load.1) nounwind
  call void @llvm.dbg.value(metadata !{%struct.matrix_mul* %this}, i64 0, metadata !2172) nounwind
  call void @llvm.dbg.value(metadata !{i32* %ptData32.assign.5}, i64 0, metadata !2174) nounwind
  call void @llvm.dbg.value(metadata !{%struct.matrix_mul* %this}, i64 0, metadata !2175) nounwind
  call void @llvm.dbg.value(metadata !{i32* %ptData32.assign.5}, i64 0, metadata !2181) nounwind
  %P.assign.5 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 6, i32 0, i32 0, i32 0, !dbg !2182 ; <%"struct._ap_sc_::sc_dt::sc_lv<1>"*> [#uses=2]
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.5}, i64 0, metadata !1977) nounwind
  call void @llvm.dbg.declare(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %val.3}, metadata !1981) nounwind, !dbg !2190
  call void (...)* @_ssdm_op_IfRead(%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.5, %"struct._ap_sc_::sc_dt::sc_lv<1>"* %val.3) nounwind, !dbg !2191
  %val.3.addr = getelementptr inbounds %"struct._ap_sc_::sc_dt::sc_lv<1>"* %val.3, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2192 ; <i1*> [#uses=1]
  %tmp.V.5 = load i1* %val.3.addr, align 8, !dbg !2192 ; <i1> [#uses=1]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %tmp.V.5) nounwind
  call void @llvm.dbg.value(metadata !{i1 %tmp.V.5}, i64 0, metadata !1987) nounwind, !dbg !2182
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.5}, i64 0, metadata !1977) nounwind
  %this_addr.i.i.i.i73.0.i.addr = getelementptr inbounds %"struct._ap_sc_::sc_dt::sc_lv<1>"* %this_addr.i.i.i.i73.0.i, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2193 ; <i1*> [#uses=1]
  %tmp.i.i.i45.i.addr = getelementptr inbounds %"struct._ap_sc_::sc_dt::sc_lv<32>"* %tmp.22, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2198 ; <i32*> [#uses=1]
  %tmp.i.i.i31.i.addr = getelementptr inbounds %"struct._ap_sc_::sc_dt::sc_lv<1>"* %tmp.23, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2202 ; <i1*> [#uses=1]
  %tmp.i.i.i10.i.addr = getelementptr inbounds %"struct._ap_sc_::sc_dt::sc_lv<32>"* %tmp.24, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2206 ; <i32*> [#uses=1]
  %tmp.i.i.i.i41.addr = getelementptr inbounds %"struct._ap_sc_::sc_dt::sc_lv<1>"* %tmp.25, i32 0, i32 0, i32 0, i32 0, i32 0, !dbg !2202 ; <i1*> [#uses=1]
  br label %bb10.i53

bb.i83.i:                                         ; preds = %bb5.i47
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2209
  br label %bb5.i47, !dbg !2209

bb5.i47:                                          ; preds = %bb5.i47.preheader, %bb.i83.i
  call void (...)* @_ssdm_op_IfRead(%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.5, %"struct._ap_sc_::sc_dt::sc_lv<1>"* %this_addr.i.i.i.i73.0.i) nounwind, !dbg !2210
  %tmp.V.7 = load i1* %this_addr.i.i.i.i73.0.i.addr, align 8, !dbg !2193 ; <i1> [#uses=2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %tmp.V.7) nounwind
  call void @llvm.dbg.value(metadata !{i1 %tmp.V.7}, i64 0, metadata !1987) nounwind, !dbg !2194
  br i1 %tmp.V.7, label %bb.i83.i, label %bb7.i48, !dbg !2196

bb7.i48:                                          ; preds = %bb5.i47
  %v.assign = load i32* %ptData32.assign.6, align 4, !dbg !2211 ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %v.assign}, i64 0, metadata !2212) nounwind
  call void @llvm.dbg.value(metadata !{i32 %v.assign}, i64 0, metadata !2214) nounwind
  call void @llvm.dbg.value(metadata !{i32 %v.assign}, i64 0, metadata !2216) nounwind, !dbg !2218
  %tmp.13 = icmp ult i32 %i.4, 89999, !dbg !2220  ; <i1> [#uses=1]
  br i1 %tmp.13, label %bb8.i, label %bb9.i50, !dbg !2220

bb8.i:                                            ; preds = %bb7.i48
  br label %bb9.i50, !dbg !2221

bb9.i50:                                          ; preds = %bb8.i, %bb7.i48
  %ptData3.0.i2 = phi i32 [ 1, %bb8.i ], [ 0, %bb7.i48 ] ; <i32> [#uses=1]
  %ptData32.assign.8 = getelementptr i32* %ptData32.assign.6, i32 %ptData3.0.i2, !dbg !2221 ; <i32*> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32* %ptData32.assign.8}, i64 0, metadata !2181) nounwind
  call void @llvm.dbg.value(metadata !{i32 %v.assign}, i64 0, metadata !2222) nounwind, !dbg !2224
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<32>"* %P.assign.2}, i64 0, metadata !1938) nounwind
  call void @llvm.dbg.declare(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<32>"* %tmp.22}, metadata !1943) nounwind, !dbg !2225
  store i32 %v.assign, i32* %tmp.i.i.i45.i.addr, align 8, !dbg !2198
  call void (...)* @_ssdm_op_IfWrite(%"struct._ap_sc_::sc_dt::sc_lv<32>"* %P.assign.2, %"struct._ap_sc_::sc_dt::sc_lv<32>"* %tmp.22) nounwind, !dbg !2226
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.1}, i64 0, metadata !1912) nounwind
  call void @llvm.dbg.declare(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %tmp.23}, metadata !1918) nounwind, !dbg !2227
  store i1 true, i1* %tmp.i.i.i31.i.addr, align 8, !dbg !2202
  call void (...)* @_ssdm_op_IfWrite(%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.1, %"struct._ap_sc_::sc_dt::sc_lv<1>"* %tmp.23) nounwind, !dbg !2228
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2229
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<32>"* %P.assign.2}, i64 0, metadata !1938) nounwind
  call void @llvm.dbg.declare(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<32>"* %tmp.24}, metadata !1943) nounwind, !dbg !2230
  store i32 0, i32* %tmp.i.i.i10.i.addr, align 8, !dbg !2206
  call void (...)* @_ssdm_op_IfWrite(%"struct._ap_sc_::sc_dt::sc_lv<32>"* %P.assign.2, %"struct._ap_sc_::sc_dt::sc_lv<32>"* %tmp.24) nounwind, !dbg !2231
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.1}, i64 0, metadata !1912) nounwind
  call void @llvm.dbg.declare(metadata !{%"struct._ap_sc_::sc_dt::sc_lv<1>"* %tmp.25}, metadata !1918) nounwind, !dbg !2227
  store i1 false, i1* %tmp.i.i.i.i41.addr, align 8, !dbg !2202
  call void (...)* @_ssdm_op_IfWrite(%"struct._ap_sc_::sc_dt::sc_lv<1>"* %P.assign.1, %"struct._ap_sc_::sc_dt::sc_lv<1>"* %tmp.25) nounwind, !dbg !2228
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !2229
  %i.7 = add i32 %i.4, 1, !dbg !2232              ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %i.7}, i64 0, metadata !2233) nounwind, !dbg !2232
  br label %bb10.i53, !dbg !2232
...
bb10.i53:                                         ; preds = %bb9.i50, %multiplyMat.exit
  ...
  call void @llvm.dbg.value(metadata !{i32* %ptData32.assign.6}, i64 0, metadata !2181) nounwind
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !2233) nounwind
  %exitcond220.i = icmp eq i32 %i.4, 90000, !dbg !2232 ; <i1> [#uses=1]
  br i1 %exitcond220.i, label %bb.loopexit, label %bb5.i47.preheader, !dbg !2232
...
entry:
  call void @llvm.dbg.value(metadata !{%struct.matrix_mul* %this}, i64 0, metadata !2234)
  call void @llvm.dbg.value(metadata !{%"struct._ap_sc_::sc_core::sc_interface"* %zName}, i64 0, metadata !2236)
  call void (...)* @_ssdm_op_SpecTopModule(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0)) nounwind, !dbg !2238
  call void (...)* @_ssdm_InlineSelf(i32 2) nounwind, !dbg !2238
  %"matrix_mul::__ssdm_thread_M_thread.load" = load i1* @"matrix_mul::__ssdm_thread_M_thread", align 1, !dbg !2241 ; <i1> [#uses=1]
  br i1 %"matrix_mul::__ssdm_thread_M_thread.load", label %bb, label %bb1, !dbg !2241

bb:                                               ; preds = %entry
  call void @"matrix_mul::thread"(%struct.matrix_mul* %this) nounwind noinline, !dbg !2241
  unreachable

bb1:                                              ; preds = %entry
  call void (...)* @_ssdm_op_SpecProcessDecl(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 2, i8* getelementptr inbounds ([7 x i8]* @.str17, i32 0, i32 0)) nounwind, !dbg !2241
  %this.addr = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 1, !dbg !2242 ; <%"struct._ap_sc_::sc_core::sc_in<bool>"*> [#uses=3]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([7 x i8]* @.str17, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<bool>"* %this.addr, i32 1) nounwind, !dbg !2242
  %this.addr.25 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 0, !dbg !2243 ; <%"struct._ap_sc_::sc_core::sc_in<bool>"*> [#uses=3]
  call void (...)* @_ssdm_op_SpecSensitive(i8* getelementptr inbounds ([7 x i8]* @.str17, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str7, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<bool>"* %this.addr.25, i32 3) nounwind, !dbg !2243
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str7, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_in<bool>"* %this.addr.25) nounwind, !dbg !2244
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([7 x i8]* @.str6, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_in<bool>"* %this.addr) nounwind, !dbg !2245
  %this.addr.26 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 2, !dbg !2246 ; <%"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<1> >"*> [#uses=2]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([18 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8]* @.str10, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.26) nounwind, !dbg !2246
  %this.addr.27 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 3, !dbg !2247 ; <%"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<1> >"*> [#uses=2]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([18 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str11, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.27) nounwind, !dbg !2247
  %this.addr.28 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 4, !dbg !2248 ; <%"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<32> >"*> [#uses=2]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([19 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8]* @.str13, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<32> >"* %this.addr.28) nounwind, !dbg !2248
  %this.addr.29 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 5, !dbg !2249 ; <%"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<1> >"*> [#uses=2]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([18 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8]* @.str14, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.29) nounwind, !dbg !2249
  %this.addr.30 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 6, !dbg !2250 ; <%"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<1> >"*> [#uses=2]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 0, i8* getelementptr inbounds ([18 x i8]* @.str9, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str15, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.30) nounwind, !dbg !2250
  %this.addr.31 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 7, !dbg !2251 ; <%"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<32> >"*> [#uses=2]
  call void (...)* @_ssdm_op_SpecPort(i8* getelementptr inbounds ([11 x i8]* @.str5, i32 0, i32 0), i32 1, i8* getelementptr inbounds ([19 x i8]* @.str12, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str16, i32 0, i32 0), i32 0, i32 0, %"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<32> >"* %this.addr.31) nounwind, !dbg !2251
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str7, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<bool>"* %this.addr.25) nounwind, !dbg !2252
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([10 x i8]* @.str8, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<bool>"* %this.addr) nounwind, !dbg !2253
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([17 x i8]* @.str10, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.26) nounwind, !dbg !2254
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str11, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.27) nounwind, !dbg !2255
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([15 x i8]* @.str13, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<32> >"* %this.addr.28) nounwind, !dbg !2256
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([18 x i8]* @.str14, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.29) nounwind, !dbg !2257
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str15, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_in<_ap_sc_::sc_dt::sc_lv<1> >"* %this.addr.30) nounwind, !dbg !2258
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([16 x i8]* @.str16, i32 0, i32 0), %"struct._ap_sc_::sc_core::sc_out<_ap_sc_::sc_dt::sc_lv<32> >"* %this.addr.31) nounwind, !dbg !2259
  %this.addr.32 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 8, !dbg !2260 ; <[90000 x i32]*> [#uses=1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([9 x i8]* @.str20, i32 0, i32 0), [90000 x i32]* %this.addr.32) nounwind, !dbg !2260
  %this.addr.33 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 9, !dbg !2261 ; <[90000 x i32]*> [#uses=1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str21, i32 0, i32 0), [90000 x i32]* %this.addr.33) nounwind, !dbg !2261
  %this.addr.34 = getelementptr inbounds %struct.matrix_mul* %this, i32 0, i32 10, !dbg !2262 ; <[90000 x i32]*> [#uses=1]
  call void (...)* @_ssdm_op_SpecExt(i8* getelementptr inbounds ([12 x i8]* @.str19, i32 0, i32 0), i8* getelementptr inbounds ([11 x i8]* @.str22, i32 0, i32 0), [90000 x i32]* %this.addr.34) nounwind, !dbg !2262
  ret void, !dbg !2245
}
...
!2 = metadata !{i32 458769, i32 0, i32 4, metadata !"SpaceTypes.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!17 = metadata !{i32 458769, i32 0, i32 4, metadata !"<built-in>", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!18 = metadata !{i32 458769, i32 0, i32 4, metadata !"iostream", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!31 = metadata !{i32 458769, i32 0, i32 4, metadata !"postypes.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!113 = metadata !{i32 458769, i32 0, i32 4, metadata !"locale_classes.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!136 = metadata !{i32 458769, i32 0, i32 4, metadata !"stddef.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/include", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!146 = metadata !{i32 458769, i32 0, i32 4, metadata !"cstring", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!272 = metadata !{i32 458769, i32 0, i32 4, metadata !"stringfwd.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!276 = metadata !{i32 458769, i32 0, i32 4, metadata !"basic_string.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!285 = metadata !{i32 458769, i32 0, i32 4, metadata !"cstdio", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!325 = metadata !{i32 458769, i32 0, i32 4, metadata !"allocator.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!388 = metadata !{i32 458769, i32 0, i32 4, metadata !"basic_string.tcc", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!403 = metadata !{i32 458769, i32 0, i32 4, metadata !"stl_iterator.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include/c++/4.2.1/bits", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!437 = metadata !{i32 458769, i32 0, i32 4, metadata !"locale.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/c:/logiciels/xilinx/vivado_hls/2012.4/win_x86/tools/llvm_gcc/bin/../lib/gcc/i686-pc-mingw32/4.2.1/../../../../include", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!829 = metadata !{i32 458804, i32 0, metadata !1, metadata !"ssdm_global_array_ins", metadata !"ssdm_global_array_ins", metadata !"", metadata !830, i32 274, metadata !831, i1 true, i1 true, null} ; [ DW_TAG_variable ]
!830 = metadata !{i32 458769, i32 0, i32 4, metadata !"matrix_mul.cpp", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
!831 = metadata !{i32 458771, metadata !1, metadata !"ssdm_global_array_matrix_mulcppaplinecpp", metadata !830, i32 260, i64 8, i64 8, i64 0, i32 0, null, metadata !832, i32 0, null} ; [ DW_TAG_structure_type ]
!832 = metadata !{metadata !833}
!833 = metadata !{i32 458798, i32 0, metadata !831, metadata !"ssdm_global_array_matrix_mulcppaplinecpp", metadata !"ssdm_global_array_matrix_mulcppaplinecpp", metadata !"", metadata !830, i32 262, metadata !834, i1 false, i1 false, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!837 = metadata !{i32 458804, i32 0, metadata !1, metadata !"ssdm_ins_matrix_mul_0_0", metadata !"ssdm_ins_matrix_mul_0_0", metadata !"", metadata !830, i32 276, metadata !838, i1 false, i1 true, %struct.matrix_mul* @ssdm_ins_matrix_mul_0_0} ; [ DW_TAG_variable ]
...
!839 = metadata !{i32 458769, i32 0, i32 4, metadata !"matrix_mul.h", metadata !"C:\5CUsers\5Cgabil\5CDocuments\5Cinf3610_tp4\5Cimplementation2\5Chls\5Cmatrix_mul/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build)", i1 false, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_unit ]
...
!1870 = metadata !{i32 458798, i32 0, metadata !838, metadata !"RegisterRead", metadata !"RegisterRead", metadata !"_ZN10matrix_mul12RegisterReadEhmPm", metadata !830, i32 238, metadata !1871, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1875 = metadata !{i32 458798, i32 0, metadata !838, metadata !"RegisterWrite", metadata !"RegisterWrite", metadata !"_ZN10matrix_mul13RegisterWriteEhmPKm", metadata !830, i32 244, metadata !1876, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1879 = metadata !{i32 458798, i32 0, metadata !838, metadata !"MakeSignalsInactive", metadata !"MakeSignalsInactive", metadata !"_ZN10matrix_mul19MakeSignalsInactiveEv", metadata !830, i32 249, metadata !1868, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1902 = metadata !{i32 459009, metadata !1879, metadata !"this", metadata !830, i32 249, metadata !1885} ; [ DW_TAG_arg_variable ]
...
!1910 = metadata !{i32 252, i32 0, metadata !1911, metadata !1891}
!1911 = metadata !{i32 458763, metadata !1879, i32 249, i32 0} ; [ DW_TAG_lexical_block ]
...
!1926 = metadata !{i32 254, i32 0, metadata !1911, metadata !1891}
...
!1937 = metadata !{i32 255, i32 0, metadata !1911, metadata !1891}
...
!1965 = metadata !{i32 459009, metadata !1966, metadata !"module", metadata !830, i32 110, metadata !1886} ; [ DW_TAG_arg_variable ]
!1966 = metadata !{i32 458798, i32 0, metadata !1, metadata !"ModuleRead_1", metadata !"ModuleRead_1", metadata !"_Z12ModuleRead_1P10matrix_mulmPjm", metadata !830, i32 110, metadata !1967, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1969 = metadata !{i32 459009, metadata !1966, metadata !"ptData32", metadata !830, i32 110, metadata !1963} ; [ DW_TAG_arg_variable ]
!1970 = metadata !{i32 72, i32 0, metadata !1273, metadata !1971}
!1971 = metadata !{i32 224, i32 0, metadata !1389, metadata !1972}
!1972 = metadata !{i32 117, i32 0, metadata !1973, metadata !1975}
!1973 = metadata !{i32 458763, metadata !1974, i32 110, i32 0} ; [ DW_TAG_lexical_block ]
!1974 = metadata !{i32 458763, metadata !1966, i32 110, i32 0} ; [ DW_TAG_lexical_block ]
!1975 = metadata !{i32 211, i32 0, metadata !1976, metadata !1957}
...
!2002 = metadata !{i32 126, i32 0, metadata !2003, metadata !1975}
!2003 = metadata !{i32 458763, metadata !1973, i32 121, i32 0} ; [ DW_TAG_lexical_block ]
!2004 = metadata !{i32 72, i32 0, metadata !1702, metadata !2005}
!2005 = metadata !{i32 224, i32 0, metadata !1748, metadata !2006}
!2006 = metadata !{i32 127, i32 0, metadata !2003, metadata !1975}
...
!2016 = metadata !{i32 132, i32 0, metadata !2003, metadata !1975}
...
!2035 = metadata !{i32 462849, metadata !2036, metadata !"temp.V", metadata !830, i32 127, metadata !2108} ; [ DW_TAG_auto_variable_field ]
!2036 = metadata !{i32 459008, metadata !2003, metadata !"temp", metadata !830, i32 127, metadata !2037} ; [ DW_TAG_auto_variable ]
...
!2111 = metadata !{i32 128, i32 0, metadata !2003, metadata !1975}
!2112 = metadata !{i32 129, i32 0, metadata !2003, metadata !1975}
!2113 = metadata !{i32 130, i32 0, metadata !2003, metadata !1975}
...
!2117 = metadata !{i32 121, i32 0, metadata !1973, metadata !1975}
!2118 = metadata !{i32 459008, metadata !1973, metadata !"i", metadata !830, i32 114, metadata !137} ; [ DW_TAG_auto_variable ]
...
!2123 = metadata !{i32 117, i32 0, metadata !1973, metadata !2124}
!2124 = metadata !{i32 211, i32 0, metadata !1976, metadata !2119}
...
!2130 = metadata !{i32 126, i32 0, metadata !2003, metadata !2124}
!2131 = metadata !{i32 72, i32 0, metadata !1702, metadata !2132}
!2132 = metadata !{i32 224, i32 0, metadata !1748, metadata !2133}
!2133 = metadata !{i32 127, i32 0, metadata !2003, metadata !2124}
...
!2138 = metadata !{i32 132, i32 0, metadata !2003, metadata !2124}
...
!2144 = metadata !{i32 128, i32 0, metadata !2003, metadata !2124}
!2145 = metadata !{i32 129, i32 0, metadata !2003, metadata !2124}
!2146 = metadata !{i32 130, i32 0, metadata !2003, metadata !2124}
...
!2150 = metadata !{i32 121, i32 0, metadata !1973, metadata !2124}
...
!2154 = metadata !{i32 83, i32 0, metadata !2152, metadata !1899}
...
!2159 = metadata !{i32 82, i32 0, metadata !2152, metadata !1899}
!2160 = metadata !{i32 459008, metadata !2152, metadata !"sum", metadata !830, i32 73, metadata !137} ; [ DW_TAG_auto_variable ]
!2161 = metadata !{i32 84, i32 0, metadata !2152, metadata !1899}
!2162 = metadata !{i32 459008, metadata !2152, metadata !"k", metadata !830, i32 73, metadata !137} ; [ DW_TAG_auto_variable ]
!2163 = metadata !{i32 85, i32 0, metadata !2152, metadata !1899}
!2164 = metadata !{i32 86, i32 0, metadata !2152, metadata !1899}
!2165 = metadata !{i32 459008, metadata !2152, metadata !"j", metadata !830, i32 73, metadata !137} ; [ DW_TAG_auto_variable ]
!2166 = metadata !{i32 87, i32 0, metadata !2152, metadata !1899}
!2167 = metadata !{i32 75, i32 0, metadata !2152, metadata !1899}
!2168 = metadata !{i32 459008, metadata !2152, metadata !"i", metadata !830, i32 73, metadata !137} ; [ DW_TAG_auto_variable ]
!2169 = metadata !{i32 459009, metadata !1882, metadata !"this", metadata !830, i32 67, metadata !1885} ; [ DW_TAG_arg_variable ]
!2170 = metadata !{i32 68, i32 0, metadata !2171, metadata !1900}
!2171 = metadata !{i32 458763, metadata !1882, i32 67, i32 0} ; [ DW_TAG_lexical_block ]
!2172 = metadata !{i32 459009, metadata !2173, metadata !"this", metadata !839, i32 48, metadata !1885} ; [ DW_TAG_arg_variable ]
!2173 = metadata !{i32 458798, i32 0, metadata !838, metadata !"ModuleWrite<unsigned int>", metadata !"ModuleWrite<unsigned int>", metadata !"_ZN10matrix_mul11ModuleWriteIjEEhhmPT_m", metadata !839, i32 48, metadata !1961, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!2174 = metadata !{i32 459009, metadata !2173, metadata !"ptData32", metadata !839, i32 48, metadata !1963} ; [ DW_TAG_arg_variable ]
!2175 = metadata !{i32 459009, metadata !2176, metadata !"module", metadata !830, i32 164, metadata !1886} ; [ DW_TAG_arg_variable ]
!2176 = metadata !{i32 458798, i32 0, metadata !1, metadata !"ModuleWrite_1", metadata !"ModuleWrite_1", metadata !"_Z13ModuleWrite_1P10matrix_mulmPKjm", metadata !830, i32 164, metadata !2177, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!2177 = metadata !{i32 458773, metadata !1, metadata !"", metadata !1, i32 0, i64 0, i64 0, i64 0, i32 0, null, metadata !2178, i32 0, null} ; [ DW_TAG_subroutine_type ]
!2178 = metadata !{metadata !1873, metadata !1886, metadata !11, metadata !2179, metadata !11}
!2179 = metadata !{i32 458767, metadata !1, metadata !"", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2180} ; [ DW_TAG_pointer_type ]
!2180 = metadata !{i32 458790, metadata !1, metadata !"", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !137} ; [ DW_TAG_const_type ]
!2181 = metadata !{i32 459009, metadata !2176, metadata !"ptData32", metadata !830, i32 164, metadata !2179} ; [ DW_TAG_arg_variable ]
!2182 = metadata !{i32 72, i32 0, metadata !1273, metadata !2183}
!2183 = metadata !{i32 224, i32 0, metadata !1389, metadata !2184}
!2184 = metadata !{i32 171, i32 0, metadata !2185, metadata !2187}
!2185 = metadata !{i32 458763, metadata !2186, i32 164, i32 0} ; [ DW_TAG_lexical_block ]
!2186 = metadata !{i32 458763, metadata !2176, i32 164, i32 0} ; [ DW_TAG_lexical_block ]
!2187 = metadata !{i32 220, i32 0, metadata !2188, metadata !2189}
!2188 = metadata !{i32 458763, metadata !2173, i32 48, i32 0} ; [ DW_TAG_lexical_block ]
!2189 = metadata !{i32 69, i32 0, metadata !2171, metadata !1900}
!2190 = metadata !{i32 25, i32 0, metadata !1982, metadata !2182}
!2191 = metadata !{i32 30, i32 0, metadata !1982, metadata !2182}
!2192 = metadata !{i32 31, i32 0, metadata !1982, metadata !2182}
!2193 = metadata !{i32 31, i32 0, metadata !1982, metadata !2194}
!2194 = metadata !{i32 72, i32 0, metadata !1273, metadata !2195}
!2195 = metadata !{i32 224, i32 0, metadata !1389, metadata !2196}
!2196 = metadata !{i32 182, i32 0, metadata !2197, metadata !2187}
!2197 = metadata !{i32 458763, metadata !2185, i32 175, i32 0} ; [ DW_TAG_lexical_block ]
!2198 = metadata !{i32 19, i32 0, metadata !1944, metadata !2199}
!2199 = metadata !{i32 99, i32 0, metadata !1931, metadata !2200}
!2200 = metadata !{i32 300, i32 0, metadata !1819, metadata !2201}
!2201 = metadata !{i32 188, i32 0, metadata !2197, metadata !2187}
!2202 = metadata !{i32 19, i32 0, metadata !1919, metadata !2203}
!2203 = metadata !{i32 99, i32 0, metadata !1904, metadata !2204}
!2204 = metadata !{i32 300, i32 0, metadata !1329, metadata !2205}
!2205 = metadata !{i32 189, i32 0, metadata !2197, metadata !2187}
!2206 = metadata !{i32 19, i32 0, metadata !1944, metadata !2207}
!2207 = metadata !{i32 99, i32 0, metadata !1931, metadata !2208}
!2208 = metadata !{i32 300, i32 0, metadata !1819, metadata !2205}
!2209 = metadata !{i32 705, i32 0, metadata !1950, metadata !2196}
!2210 = metadata !{i32 30, i32 0, metadata !1982, metadata !2194}
!2211 = metadata !{i32 183, i32 0, metadata !2197, metadata !2187}
!2212 = metadata !{i32 459009, metadata !2213, metadata !"v", metadata !845, i32 298, metadata !137} ; [ DW_TAG_arg_variable ]
!2213 = metadata !{i32 458798, i32 0, metadata !2037, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi32EEC1Ej", metadata !845, i32 298, metadata !2068, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!2214 = metadata !{i32 459009, metadata !2215, metadata !"op", metadata !972, i32 1372, metadata !137} ; [ DW_TAG_arg_variable ]
!2215 = metadata !{i32 458798, i32 0, metadata !1417, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb0EEC2Ej", metadata !972, i32 1372, metadata !1463, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!2216 = metadata !{i32 462849, metadata !2217, metadata !"temp.V", metadata !830, i32 180, metadata !2108} ; [ DW_TAG_auto_variable_field ]
!2217 = metadata !{i32 459008, metadata !2197, metadata !"temp", metadata !830, i32 180, metadata !2037} ; [ DW_TAG_auto_variable ]
!2218 = metadata !{i32 332, i32 0, metadata !2219, metadata !2211}
!2219 = metadata !{i32 458763, metadata !2104, i32 331, i32 0} ; [ DW_TAG_lexical_block ]
!2220 = metadata !{i32 185, i32 0, metadata !2197, metadata !2187}
!2221 = metadata !{i32 186, i32 0, metadata !2197, metadata !2187}
!2222 = metadata !{i32 462849, metadata !2223, metadata !"v.V", metadata !846, i32 98, metadata !2027} ; [ DW_TAG_auto_variable_field ]
!2223 = metadata !{i32 459008, metadata !1931, metadata !"v", metadata !846, i32 98, metadata !1414} ; [ DW_TAG_auto_variable ]
!2224 = metadata !{i32 98, i32 0, metadata !1931, metadata !2200}
!2225 = metadata !{i32 15, i32 0, metadata !1944, metadata !2199}
!2226 = metadata !{i32 20, i32 0, metadata !1944, metadata !2199}
!2227 = metadata !{i32 15, i32 0, metadata !1919, metadata !2203}
!2228 = metadata !{i32 20, i32 0, metadata !1919, metadata !2203}
!2229 = metadata !{i32 705, i32 0, metadata !1950, metadata !2205}
!2230 = metadata !{i32 15, i32 0, metadata !1944, metadata !2207}
!2231 = metadata !{i32 20, i32 0, metadata !1944, metadata !2207}
!2232 = metadata !{i32 175, i32 0, metadata !2185, metadata !2187}
!2233 = metadata !{i32 459008, metadata !2185, metadata !"i", metadata !830, i32 168, metadata !137} ; [ DW_TAG_auto_variable ]
!2234 = metadata !{i32 459009, metadata !2235, metadata !"this", metadata !830, i32 22, metadata !1885} ; [ DW_TAG_arg_variable ]
!2235 = metadata !{i32 458798, i32 0, metadata !838, metadata !"matrix_mul", metadata !"matrix_mul", metadata !"_ZN10matrix_mulC1EN7_ap_sc_7sc_core14sc_module_nameE", metadata !830, i32 22, metadata !1847, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!2236 = metadata !{i32 459009, metadata !2235, metadata !"zName", metadata !830, i32 22, metadata !2237} ; [ DW_TAG_arg_variable ]
!2237 = metadata !{i32 458768, metadata !1, metadata !"sc_module_name", metadata !1, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !1850} ; [ DW_TAG_reference_type ]
!2238 = metadata !{i32 24, i32 0, metadata !2239, null}
!2239 = metadata !{i32 458763, metadata !2240, i32 22, i32 0} ; [ DW_TAG_lexical_block ]
!2240 = metadata !{i32 458763, metadata !2235, i32 22, i32 0} ; [ DW_TAG_lexical_block ]
!2241 = metadata !{i32 25, i32 0, metadata !2239, null}
!2242 = metadata !{i32 26, i32 0, metadata !2239, null}
!2243 = metadata !{i32 27, i32 0, metadata !2239, null}
!2244 = metadata !{i32 28, i32 0, metadata !2239, null}
!2245 = metadata !{i32 29, i32 0, metadata !2239, null}
!2246 = metadata !{i32 30, i32 0, metadata !2239, null}
!2247 = metadata !{i32 31, i32 0, metadata !2239, null}
!2248 = metadata !{i32 32, i32 0, metadata !2239, null}
!2249 = metadata !{i32 33, i32 0, metadata !2239, null}
!2250 = metadata !{i32 34, i32 0, metadata !2239, null}
!2251 = metadata !{i32 35, i32 0, metadata !2239, null}
!2252 = metadata !{i32 36, i32 0, metadata !2239, null}
!2253 = metadata !{i32 37, i32 0, metadata !2239, null}
!2254 = metadata !{i32 38, i32 0, metadata !2239, null}
!2255 = metadata !{i32 39, i32 0, metadata !2239, null}
!2256 = metadata !{i32 40, i32 0, metadata !2239, null}
!2257 = metadata !{i32 41, i32 0, metadata !2239, null}
!2258 = metadata !{i32 42, i32 0, metadata !2239, null}
!2259 = metadata !{i32 43, i32 0, metadata !2239, null}
!2260 = metadata !{i32 44, i32 0, metadata !2239, null}
!2261 = metadata !{i32 45, i32 0, metadata !2239, null}
!2262 = metadata !{i32 46, i32 0, metadata !2239, null}

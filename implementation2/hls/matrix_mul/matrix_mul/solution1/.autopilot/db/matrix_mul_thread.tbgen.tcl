...
set C_modelArgList { 
	...
	{ m_operand1 int 32 {array 90000 { 2 1 } 1 1 }  }
	{ m_operand2 int 32 {array 90000 { 2 1 } 1 1 }  }
}
...
set portList { 
	...
	{ m_operand1_address1 sc_out sc_lv 17 signal 9 } 
	{ m_operand1_ce1 sc_out sc_logic 1 signal 9 } 
	{ m_operand1_q1 sc_in sc_lv 32 signal 9 } 
	...
	{ m_operand2_address1 sc_out sc_lv 17 signal 10 } 
	{ m_operand2_ce1 sc_out sc_logic 1 signal 10 } 
	{ m_operand2_q1 sc_in sc_lv 32 signal 10 } 
}
...
set Spec2ImplPortList { 
	...
	m_operand1 { ap_memory {  { m_operand1_address0 mem_address 1 17 }  { m_operand1_ce0 mem_ce 1 1 }  { m_operand1_we0 mem_we 1 1 }  { m_operand1_d0 mem_din 1 32 }  { m_operand1_q0 mem_dout 0 32 }  { m_operand1_address1 mem_address 1 17 }  { m_operand1_ce1 mem_ce 1 1 }  { m_operand1_q1 mem_dout 0 32 } } }
	m_operand2 { ap_memory {  { m_operand2_address0 mem_address 1 17 }  { m_operand2_ce0 mem_ce 1 1 }  { m_operand2_we0 mem_we 1 1 }  { m_operand2_d0 mem_din 1 32 }  { m_operand2_q0 mem_dout 0 32 }  { m_operand2_address1 mem_address 1 17 }  { m_operand2_ce1 mem_ce 1 1 }  { m_operand2_q1 mem_dout 0 32 } } }
}

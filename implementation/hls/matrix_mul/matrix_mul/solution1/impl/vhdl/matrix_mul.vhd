...
architecture behav of matrix_mul is 
    ...
    "matrix_mul,hls_ip_2012_4,{HLS_INPUT_TYPE=sc,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=6.360000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=576,HLS_SYN_DSP=4,HLS_SYN_FF=598,HLS_SYN_LUT=736}";
...
begin
    ...
    m_operand1_U : component matrix_mul_m_result
    generic map (
        DataWidth => 32,
        AddressRange => 90000,
        AddressWidth => 17)
    ...
    m_operand2_U : component matrix_mul_m_result
    generic map (
        DataWidth => 32,
        AddressRange => 90000,
        AddressWidth => 17)

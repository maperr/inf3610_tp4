...
#ifndef _matrix_mul_m_result_H_
#define _matrix_mul_m_result_H_
...
struct matrix_mul_m_result_core : public sc_core::sc_module
{
public:
    ...
    SC_HAS_PROCESS(matrix_mul_m_result_core);
    matrix_mul_m_result_core(sc_core::sc_module_name) {
        SC_METHOD(proc_di);
        sensitive << d;
...
SC_MODULE( matrix_mul_m_result )
{
    ...
    SC_CTOR( matrix_mul_m_result ) {
        meminst = new matrix_mul_m_result_core <1, 1, DataWidth, AddressWidth, AddressRange>("core_inst");
...
public:
    ...
    matrix_mul_m_result_core <1, 1, DataWidth, AddressWidth, AddressRange>* meminst;
};

#endif //_matrix_mul_m_result_H_

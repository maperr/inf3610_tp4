; ModuleID = 'C:/Users/gabil/Documents/inf3610_tp4/implementation/hls/matrix_mul/matrix_mul/solution1/.autopilot/db/a.o.3.bc'
...
bb7.i14:                                          ; preds = %bb5.i13
  ...
  store i32 %val_V, i32* %m_operand1_addr_1, align 4, !dbg !1435
...
bb11.i:                                           ; preds = %bb7.i14, %bb
  ...
  call void @llvm.dbg.value(metadata !{i32* %m_operand1_addr_1}, i64 0, metadata !1445) nounwind
  ...
  %exitcond = icmp eq i17 %i, -41072, !dbg !1444  ; <i1> [#uses=1]
  %i_3 = add i17 %i, 1, !dbg !1444                ; <i17> [#uses=1]
  br i1 %exitcond, label %ModuleRead_1.exit, label %bb5.i13, !dbg !1444
...
bb7.i31:                                          ; preds = %bb5.i29
  ...
  store i32 %val_V_1, i32* %m_operand2_addr_1, align 4, !dbg !1462
...
bb11.i38:                                         ; preds = %bb7.i31, %ModuleRead_1.exit
  ...
  call void @llvm.dbg.value(metadata !{i32* %m_operand2_addr_1}, i64 0, metadata !1445) nounwind
  ...
  %exitcond1 = icmp eq i17 %i_1, -41072, !dbg !1470 ; <i1> [#uses=1]
  %i_5 = add i17 %i_1, 1, !dbg !1470              ; <i17> [#uses=1]
  br i1 %exitcond1, label %bb7.i, label %bb5.i29, !dbg !1470

bb.i:                                             ; preds = %bb7.i
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str1) nounwind, !dbg !1471
  %tmp_9 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str1) nounwind, !dbg !1471 ; <i32> [#uses=1]
  br label %bb5.i, !dbg !1475

bb1.i:                                            ; preds = %bb5.i
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str2) nounwind, !dbg !1476
  %tmp_7 = call i32 (...)* @_ssdm_op_SpecRegionBegin([3 x i8]* @p_str2) nounwind, !dbg !1476 ; <i32> [#uses=1]
  br label %bb3.i, !dbg !1477

bb2.i:                                            ; preds = %bb3.i
  call void (...)* @_ssdm_op_SpecLoopName([3 x i8]* @p_str3) nounwind, !dbg !1478
  %tmp_2 = add i17 %k_cast, %phi_mul1, !dbg !1479 ; <i17> [#uses=1]
  %tmp_2_cast = zext i17 %tmp_2 to i32, !dbg !1479 ; <i32> [#uses=1]
  %m_operand1_addr = getelementptr [90000 x i32]* %m_operand1, i32 0, i32 %tmp_2_cast, !dbg !1479 ; <i32*> [#uses=1]
  %m_operand1_load = load i32* %m_operand1_addr, align 4, !dbg !1479 ; <i32> [#uses=1]
  %next_mul = add i17 %phi_mul, 300               ; <i17> [#uses=1]
  %tmp_5 = add i17 %phi_mul, %j_cast, !dbg !1479  ; <i17> [#uses=1]
  %tmp_5_cast = zext i17 %tmp_5 to i32, !dbg !1479 ; <i32> [#uses=1]
  %m_operand2_addr = getelementptr [90000 x i32]* %m_operand2, i32 0, i32 %tmp_5_cast, !dbg !1479 ; <i32*> [#uses=1]
  %m_operand2_load = load i32* %m_operand2_addr, align 4, !dbg !1479 ; <i32> [#uses=1]
  %tmp_6 = mul i32 %m_operand2_load, %m_operand1_load, !dbg !1479 ; <i32> [#uses=1]
  %sum_1 = add i32 %tmp_6, %sum, !dbg !1479       ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %sum_1}, i64 0, metadata !1480) nounwind, !dbg !1479
  call void @llvm.dbg.value(metadata !{i9 %k_1}, i64 0, metadata !1481) nounwind, !dbg !1477
  br label %bb3.i, !dbg !1477
...
bb3.i:                                            ; preds = %bb2.i, %bb1.i
  ...
  call void @llvm.dbg.value(metadata !{i9 %k}, i64 0, metadata !1481) nounwind
  call void @llvm.dbg.value(metadata !{i32 %sum}, i64 0, metadata !1480) nounwind
  %empty_5 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 300, i64 300, i64 300) nounwind ; <i32> [#uses=0]
  %exitcond8 = icmp eq i9 %k, -212, !dbg !1477    ; <i1> [#uses=1]
  %k_1 = add i9 %k, 1, !dbg !1477                 ; <i9> [#uses=1]
  br i1 %exitcond8, label %bb4.i, label %bb2.i, !dbg !1477

bb4.i:                                            ; preds = %bb3.i
  %tmp_1 = add i17 %j_cast, %phi_mul1, !dbg !1482 ; <i17> [#uses=1]
  %tmp_1_cast = zext i17 %tmp_1 to i32, !dbg !1482 ; <i32> [#uses=1]
  %m_result_addr = getelementptr [90000 x i32]* %m_result, i32 0, i32 %tmp_1_cast, !dbg !1482 ; <i32*> [#uses=1]
  store i32 %sum, i32* %m_result_addr, align 4, !dbg !1482
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str2, i32 %tmp_7) nounwind, !dbg !1483 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i9 %j_1}, i64 0, metadata !1484) nounwind, !dbg !1475
  br label %bb5.i, !dbg !1475

bb5.i:                                            ; preds = %bb4.i, %bb.i
  %j = phi i9 [ %j_1, %bb4.i ], [ 0, %bb.i ]      ; <i9> [#uses=3]
  %j_cast = zext i9 %j to i17                     ; <i17> [#uses=2]
  call void @llvm.dbg.value(metadata !{i9 %j}, i64 0, metadata !1484) nounwind
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 300, i64 300, i64 300) nounwind ; <i32> [#uses=0]
  %exitcond9 = icmp eq i9 %j, -212, !dbg !1475    ; <i1> [#uses=1]
  %j_1 = add i9 %j, 1, !dbg !1475                 ; <i9> [#uses=1]
  br i1 %exitcond9, label %bb6.i, label %bb1.i, !dbg !1475

bb6.i:                                            ; preds = %bb5.i
  %empty_8 = call i32 (...)* @_ssdm_op_SpecRegionEnd([3 x i8]* @p_str1, i32 %tmp_9) nounwind, !dbg !1485 ; <i32> [#uses=0]
  call void @llvm.dbg.value(metadata !{i9 %i_6}, i64 0, metadata !1486) nounwind, !dbg !1487
  br label %bb7.i, !dbg !1487
...
bb7.i:                                            ; preds = %bb6.i, %bb11.i38
  ...
  call void @llvm.dbg.value(metadata !{i9 %i_2}, i64 0, metadata !1486) nounwind
  %empty_9 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 300, i64 300, i64 300) nounwind ; <i32> [#uses=0]
  %exitcond2 = icmp eq i9 %i_2, -212, !dbg !1487  ; <i1> [#uses=1]
  %i_6 = add i9 %i_2, 1, !dbg !1487               ; <i9> [#uses=1]
  br i1 %exitcond2, label %multiplyMat.exit, label %bb.i, !dbg !1487

multiplyMat.exit:                                 ; preds = %bb7.i
  %val_V_3_0 = call i1 @_ssdm_op_WireRead.volatile.i1P(i1* %WriteFullPort_0) nounwind, !dbg !1488 ; <i1> [#uses=0]
  call void @llvm.dbg.value(metadata !{i1 %val_V_3_0}, i64 0, metadata !1330), !dbg !1488
  br label %bb10.i53

bb.i83.i:                                         ; preds = %bb5.i47
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1499
  br label %bb5.i47, !dbg !1499

bb5.i47:                                          ; preds = %bb10.i53, %bb.i83.i
  %tmp_V_4 = call i1 @_ssdm_op_WireRead.volatile.i1P(i1* %WriteFullPort_0) nounwind, !dbg !1502 ; <i1> [#uses=1]
  call void @llvm.dbg.value(metadata !{i1 %tmp_V_4}, i64 0, metadata !1338) nounwind, !dbg !1503
  br i1 %tmp_V_4, label %bb.i83.i, label %bb7.i48, !dbg !1500

bb7.i48:                                          ; preds = %bb5.i47
  %v_V = load i32* %m_result_addr_1, align 4, !dbg !1505 ; <i32> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %v_V}, i64 0, metadata !1506) nounwind
  call void @llvm.dbg.value(metadata !{i32 %v_V}, i64 0, metadata !1508) nounwind
  call void @llvm.dbg.value(metadata !{i32 %v_V}, i64 0, metadata !1510) nounwind, !dbg !1512
  %tmp_s = icmp ult i17 %i_4, -41073, !dbg !1514  ; <i1> [#uses=1]
  %ptData3_0_i2_cast = zext i1 %tmp_s to i17, !dbg !1515 ; <i17> [#uses=1]
  %ptData32_assign_8_rec = add i17 %ptData32_assign_6_rec, %ptData3_0_i2_cast, !dbg !1515 ; <i17> [#uses=1]
  call void @llvm.dbg.value(metadata !{i32 %v_V}, i64 0, metadata !1516) nounwind, !dbg !1518
  call void @llvm.dbg.value(metadata !{i32* %WriteDataPort_0}, i64 0, metadata !1200)
  call void @_ssdm_op_WireWrite.volatile.i32P(i32* %WriteDataPort_0, i32 %v_V) nounwind, !dbg !1521
  call void @llvm.dbg.value(metadata !{i1* %WriteEnablePort_0}, i64 0, metadata !1175)
  call void @_ssdm_op_WireWrite.volatile.i1P(i1* %WriteEnablePort_0, i1 true) nounwind, !dbg !1523
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1527
  call void @llvm.dbg.value(metadata !{i32* %WriteDataPort_0}, i64 0, metadata !1200)
  call void @_ssdm_op_WireWrite.volatile.i32P(i32* %WriteDataPort_0, i32 0) nounwind, !dbg !1528
  call void @llvm.dbg.value(metadata !{i1* %WriteEnablePort_0}, i64 0, metadata !1175)
  call void @_ssdm_op_WireWrite.volatile.i1P(i1* %WriteEnablePort_0, i1 false) nounwind, !dbg !1523
  call void (...)* @_ssdm_op_Wait(i32 1) nounwind, !dbg !1527
  call void @llvm.dbg.value(metadata !{i17 %i_7}, i64 0, metadata !1531) nounwind, !dbg !1532
  br label %bb10.i53, !dbg !1532
...
bb10.i53:                                         ; preds = %bb7.i48, %multiplyMat.exit
  ...
  call void @llvm.dbg.value(metadata !{i32* %m_result_addr_1}, i64 0, metadata !1533) nounwind
  call void @llvm.dbg.value(metadata !{i17 %i_4}, i64 0, metadata !1531) nounwind
  %empty_10 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 90000, i64 90000, i64 90000) nounwind ; <i32> [#uses=0]
  %exitcond7 = icmp eq i17 %i_4, -41072, !dbg !1532 ; <i1> [#uses=1]
  %i_7 = add i17 %i_4, 1, !dbg !1532              ; <i17> [#uses=1]
  br i1 %exitcond7, label %bb, label %bb5.i47, !dbg !1532
}
...
entry:
  call void @llvm.dbg.value(metadata !{i1* %nResetPort}, i64 0, metadata !1534)
  call void @llvm.dbg.value(metadata !{i1* %ClockPort}, i64 0, metadata !1537)
  call void @llvm.dbg.value(metadata !{i1* %ReadEnablePort_0}, i64 0, metadata !1538)
  call void @llvm.dbg.value(metadata !{i1* %ReadEmptyPort_0}, i64 0, metadata !1539)
  call void @llvm.dbg.value(metadata !{i32* %ReadDataPort_0}, i64 0, metadata !1540)
  call void @llvm.dbg.value(metadata !{i1* %WriteEnablePort_0}, i64 0, metadata !1541)
  call void @llvm.dbg.value(metadata !{i1* %WriteFullPort_0}, i64 0, metadata !1542)
  call void @llvm.dbg.value(metadata !{i32* %WriteDataPort_0}, i64 0, metadata !1543)
  call void @llvm.dbg.value(metadata !{[90000 x i32]* %m_result}, i64 0, metadata !1544)
  call void @llvm.dbg.value(metadata !{[90000 x i32]* %m_operand1}, i64 0, metadata !1545)
  call void @llvm.dbg.value(metadata !{[90000 x i32]* %m_operand2}, i64 0, metadata !1546)
  call void (...)* @_ssdm_op_SpecTopModule([11 x i8]* @p_str5, [11 x i8]* @p_str5) nounwind, !dbg !1547
  %matrix_mul_ssdm_thread_M_thread_load = load i1* @matrix_mul_ssdm_thread_M_thread, align 1, !dbg !1550 ; <i1> [#uses=1]
  br i1 %matrix_mul_ssdm_thread_M_thread_load, label %bb, label %bb1, !dbg !1550

bb:                                               ; preds = %entry
  call void @"matrix_mul::thread"(i1* %nResetPort, i1* %ClockPort, i1* %ReadEnablePort_0, i1* %ReadEmptyPort_0, i32* %ReadDataPort_0, i1* %WriteEnablePort_0, i1* %WriteFullPort_0, i32* %WriteDataPort_0, [90000 x i32]* %m_result, [90000 x i32]* %m_operand1, [90000 x i32]* %m_operand2), !dbg !1550
  unreachable

bb1:                                              ; preds = %entry
  call void (...)* @_ssdm_op_SpecProcessDecl([11 x i8]* @p_str5, i32 2, [7 x i8]* @p_str17) nounwind, !dbg !1550
  call void (...)* @_ssdm_op_SpecSensitive([7 x i8]* @p_str17, [10 x i8]* @p_str8, i1* %ClockPort, i32 1) nounwind, !dbg !1551
  call void (...)* @_ssdm_op_SpecSensitive([7 x i8]* @p_str17, [11 x i8]* @p_str7, i1* %nResetPort, i32 3) nounwind, !dbg !1552
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 0, [7 x i8]* @p_str6, [11 x i8]* @p_str7, i32 0, i32 0, i1* %nResetPort) nounwind, !dbg !1553
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 0, [7 x i8]* @p_str6, [10 x i8]* @p_str8, i32 0, i32 0, i1* %ClockPort) nounwind, !dbg !1554
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 1, [18 x i8]* @p_str9, [17 x i8]* @p_str10, i32 0, i32 0, i1* %ReadEnablePort_0) nounwind, !dbg !1555
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 0, [18 x i8]* @p_str9, [16 x i8]* @p_str11, i32 0, i32 0, i1* %ReadEmptyPort_0) nounwind, !dbg !1556
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 0, [19 x i8]* @p_str12, [15 x i8]* @p_str13, i32 0, i32 0, i32* %ReadDataPort_0) nounwind, !dbg !1557
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 1, [18 x i8]* @p_str9, [18 x i8]* @p_str14, i32 0, i32 0, i1* %WriteEnablePort_0) nounwind, !dbg !1558
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 0, [18 x i8]* @p_str9, [16 x i8]* @p_str15, i32 0, i32 0, i1* %WriteFullPort_0) nounwind, !dbg !1559
  call void (...)* @_ssdm_op_SpecPort([11 x i8]* @p_str5, i32 1, [19 x i8]* @p_str12, [16 x i8]* @p_str16, i32 0, i32 0, i32* %WriteDataPort_0) nounwind, !dbg !1560
  ret void, !dbg !1554
}
...
!1193 = metadata !{i32 251, i32 0, metadata !1194, metadata !1195}
!1194 = metadata !{i32 458763, metadata !1058, i32 248, i32 0} ; [ DW_TAG_lexical_block ]
...
!1199 = metadata !{i32 253, i32 0, metadata !1194, metadata !1195}
...
!1217 = metadata !{i32 254, i32 0, metadata !1194, metadata !1195}
...
!1255 = metadata !{i32 462851, metadata !1256, metadata !"module.nResetPort.m_if.Val", metadata !3, i32 109, metadata !1141} ; [ DW_TAG_arg_variable_field ]
!1256 = metadata !{i32 459009, metadata !1257, metadata !"module", metadata !3, i32 109, metadata !1140} ; [ DW_TAG_arg_variable ]
!1257 = metadata !{i32 458798, i32 0, metadata !2, metadata !"ModuleRead_1", metadata !"ModuleRead_1", metadata !"_Z12ModuleRead_1P10matrix_mulmPjm", metadata !3, i32 109, metadata !1258, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1260 = metadata !{i32 462851, metadata !1256, metadata !"module.ClockPort.m_if.Val", metadata !3, i32 109, metadata !1141} ; [ DW_TAG_arg_variable_field ]
!1261 = metadata !{i32 462851, metadata !1256, metadata !"module.ReadEnablePort_0.m_if.Val.V", metadata !3, i32 109, metadata !1144} ; [ DW_TAG_arg_variable_field ]
!1262 = metadata !{i32 462851, metadata !1256, metadata !"module.ReadEmptyPort_0.m_if.Val.V", metadata !3, i32 109, metadata !1146} ; [ DW_TAG_arg_variable_field ]
!1263 = metadata !{i32 462851, metadata !1256, metadata !"module.ReadDataPort_0.m_if.Val.V", metadata !3, i32 109, metadata !1148} ; [ DW_TAG_arg_variable_field ]
!1264 = metadata !{i32 462851, metadata !1256, metadata !"module.WriteEnablePort_0.m_if.Val.V", metadata !3, i32 109, metadata !1144} ; [ DW_TAG_arg_variable_field ]
!1265 = metadata !{i32 462851, metadata !1256, metadata !"module.WriteFullPort_0.m_if.Val.V", metadata !3, i32 109, metadata !1146} ; [ DW_TAG_arg_variable_field ]
!1266 = metadata !{i32 462851, metadata !1256, metadata !"module.WriteDataPort_0.m_if.Val.V", metadata !3, i32 109, metadata !1152} ; [ DW_TAG_arg_variable_field ]
!1267 = metadata !{i32 462851, metadata !1256, metadata !"module.m_result", metadata !3, i32 109, metadata !1154} ; [ DW_TAG_arg_variable_field ]
!1268 = metadata !{i32 462851, metadata !1256, metadata !"module.m_operand1", metadata !3, i32 109, metadata !1156} ; [ DW_TAG_arg_variable_field ]
!1269 = metadata !{i32 462851, metadata !1256, metadata !"module.m_operand2", metadata !3, i32 109, metadata !1158} ; [ DW_TAG_arg_variable_field ]
...
!1300 = metadata !{i32 462851, metadata !1301, metadata !"module.nResetPort.m_if.Val", metadata !3, i32 163, metadata !1141} ; [ DW_TAG_arg_variable_field ]
!1301 = metadata !{i32 459009, metadata !1302, metadata !"module", metadata !3, i32 163, metadata !1140} ; [ DW_TAG_arg_variable ]
!1302 = metadata !{i32 458798, i32 0, metadata !2, metadata !"ModuleWrite_1", metadata !"ModuleWrite_1", metadata !"_Z13ModuleWrite_1P10matrix_mulmPKjm", metadata !3, i32 163, metadata !1303, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
...
!1307 = metadata !{i32 462851, metadata !1301, metadata !"module.ClockPort.m_if.Val", metadata !3, i32 163, metadata !1141} ; [ DW_TAG_arg_variable_field ]
!1308 = metadata !{i32 462851, metadata !1301, metadata !"module.ReadEnablePort_0.m_if.Val.V", metadata !3, i32 163, metadata !1144} ; [ DW_TAG_arg_variable_field ]
!1309 = metadata !{i32 462851, metadata !1301, metadata !"module.ReadEmptyPort_0.m_if.Val.V", metadata !3, i32 163, metadata !1146} ; [ DW_TAG_arg_variable_field ]
!1310 = metadata !{i32 462851, metadata !1301, metadata !"module.ReadDataPort_0.m_if.Val.V", metadata !3, i32 163, metadata !1148} ; [ DW_TAG_arg_variable_field ]
!1311 = metadata !{i32 462851, metadata !1301, metadata !"module.WriteEnablePort_0.m_if.Val.V", metadata !3, i32 163, metadata !1144} ; [ DW_TAG_arg_variable_field ]
!1312 = metadata !{i32 462851, metadata !1301, metadata !"module.WriteFullPort_0.m_if.Val.V", metadata !3, i32 163, metadata !1146} ; [ DW_TAG_arg_variable_field ]
!1313 = metadata !{i32 462851, metadata !1301, metadata !"module.WriteDataPort_0.m_if.Val.V", metadata !3, i32 163, metadata !1152} ; [ DW_TAG_arg_variable_field ]
!1314 = metadata !{i32 462851, metadata !1301, metadata !"module.m_result", metadata !3, i32 163, metadata !1154} ; [ DW_TAG_arg_variable_field ]
!1315 = metadata !{i32 462851, metadata !1301, metadata !"module.m_operand1", metadata !3, i32 163, metadata !1156} ; [ DW_TAG_arg_variable_field ]
!1316 = metadata !{i32 462851, metadata !1301, metadata !"module.m_operand2", metadata !3, i32 163, metadata !1158} ; [ DW_TAG_arg_variable_field ]
...
!1322 = metadata !{i32 116, i32 0, metadata !1323, metadata !1325}
!1323 = metadata !{i32 458763, metadata !1324, i32 109, i32 0} ; [ DW_TAG_lexical_block ]
!1324 = metadata !{i32 458763, metadata !1257, i32 109, i32 0} ; [ DW_TAG_lexical_block ]
!1325 = metadata !{i32 210, i32 0, metadata !1326, metadata !1327}
...
!1333 = metadata !{i32 125, i32 0, metadata !1334, metadata !1325}
!1334 = metadata !{i32 458763, metadata !1323, i32 120, i32 0} ; [ DW_TAG_lexical_block ]
...
!1352 = metadata !{i32 126, i32 0, metadata !1334, metadata !1325}
...
!1359 = metadata !{i32 462849, metadata !1360, metadata !"temp.V", metadata !3, i32 126, metadata !1432} ; [ DW_TAG_auto_variable_field ]
!1360 = metadata !{i32 459008, metadata !1334, metadata !"temp", metadata !3, i32 126, metadata !1361} ; [ DW_TAG_auto_variable ]
...
!1435 = metadata !{i32 127, i32 0, metadata !1334, metadata !1325}
!1436 = metadata !{i32 128, i32 0, metadata !1334, metadata !1325}
!1437 = metadata !{i32 129, i32 0, metadata !1334, metadata !1325}
...
!1441 = metadata !{i32 131, i32 0, metadata !1334, metadata !1325}
!1442 = metadata !{i32 705, i32 0, metadata !1219, metadata !1441}
!1443 = metadata !{i32 459008, metadata !1323, metadata !"i", metadata !3, i32 113, metadata !199} ; [ DW_TAG_auto_variable ]
!1444 = metadata !{i32 120, i32 0, metadata !1323, metadata !1325}
!1445 = metadata !{i32 459009, metadata !1257, metadata !"ptData32", metadata !3, i32 109, metadata !1244} ; [ DW_TAG_arg_variable ]
...
!1449 = metadata !{i32 116, i32 0, metadata !1323, metadata !1450}
!1450 = metadata !{i32 210, i32 0, metadata !1326, metadata !1451}
!1451 = metadata !{i32 59, i32 0, metadata !1328, metadata !1329}
!1452 = metadata !{i32 705, i32 0, metadata !1219, metadata !1453}
!1453 = metadata !{i32 125, i32 0, metadata !1334, metadata !1450}
...
!1460 = metadata !{i32 126, i32 0, metadata !1334, metadata !1450}
!1461 = metadata !{i32 232, i32 0, metadata !1434, metadata !1460}
!1462 = metadata !{i32 127, i32 0, metadata !1334, metadata !1450}
!1463 = metadata !{i32 128, i32 0, metadata !1334, metadata !1450}
!1464 = metadata !{i32 129, i32 0, metadata !1334, metadata !1450}
...
!1468 = metadata !{i32 131, i32 0, metadata !1334, metadata !1450}
!1469 = metadata !{i32 705, i32 0, metadata !1219, metadata !1468}
!1470 = metadata !{i32 120, i32 0, metadata !1323, metadata !1450}
...
!1475 = metadata !{i32 77, i32 0, metadata !1472, metadata !1474}
!1476 = metadata !{i32 78, i32 0, metadata !1472, metadata !1474}
!1477 = metadata !{i32 80, i32 0, metadata !1472, metadata !1474}
!1478 = metadata !{i32 81, i32 0, metadata !1472, metadata !1474}
!1479 = metadata !{i32 82, i32 0, metadata !1472, metadata !1474}
!1480 = metadata !{i32 459008, metadata !1472, metadata !"sum", metadata !3, i32 73, metadata !199} ; [ DW_TAG_auto_variable ]
!1481 = metadata !{i32 459008, metadata !1472, metadata !"k", metadata !3, i32 73, metadata !199} ; [ DW_TAG_auto_variable ]
!1482 = metadata !{i32 84, i32 0, metadata !1472, metadata !1474}
!1483 = metadata !{i32 85, i32 0, metadata !1472, metadata !1474}
!1484 = metadata !{i32 459008, metadata !1472, metadata !"j", metadata !3, i32 73, metadata !199} ; [ DW_TAG_auto_variable ]
!1485 = metadata !{i32 86, i32 0, metadata !1472, metadata !1474}
!1486 = metadata !{i32 459008, metadata !1472, metadata !"i", metadata !3, i32 73, metadata !199} ; [ DW_TAG_auto_variable ]
!1487 = metadata !{i32 75, i32 0, metadata !1472, metadata !1474}
!1488 = metadata !{i32 30, i32 0, metadata !1318, metadata !1489}
!1489 = metadata !{i32 72, i32 0, metadata !450, metadata !1490}
!1490 = metadata !{i32 224, i32 0, metadata !566, metadata !1491}
!1491 = metadata !{i32 170, i32 0, metadata !1492, metadata !1494}
!1492 = metadata !{i32 458763, metadata !1493, i32 163, i32 0} ; [ DW_TAG_lexical_block ]
!1493 = metadata !{i32 458763, metadata !1302, i32 163, i32 0} ; [ DW_TAG_lexical_block ]
!1494 = metadata !{i32 219, i32 0, metadata !1495, metadata !1496}
!1495 = metadata !{i32 458763, metadata !1289, i32 48, i32 0} ; [ DW_TAG_lexical_block ]
!1496 = metadata !{i32 69, i32 0, metadata !1497, metadata !1498}
!1497 = metadata !{i32 458763, metadata !1061, i32 67, i32 0} ; [ DW_TAG_lexical_block ]
!1498 = metadata !{i32 47, i32 0, metadata !1160, null}
!1499 = metadata !{i32 705, i32 0, metadata !1219, metadata !1500}
!1500 = metadata !{i32 181, i32 0, metadata !1501, metadata !1494}
!1501 = metadata !{i32 458763, metadata !1492, i32 174, i32 0} ; [ DW_TAG_lexical_block ]
!1502 = metadata !{i32 30, i32 0, metadata !1318, metadata !1503}
!1503 = metadata !{i32 72, i32 0, metadata !450, metadata !1504}
!1504 = metadata !{i32 224, i32 0, metadata !566, metadata !1500}
!1505 = metadata !{i32 182, i32 0, metadata !1501, metadata !1494}
!1506 = metadata !{i32 459009, metadata !1507, metadata !"v", metadata !11, i32 298, metadata !199} ; [ DW_TAG_arg_variable ]
!1507 = metadata !{i32 458798, i32 0, metadata !1361, metadata !"sc_uint", metadata !"sc_uint", metadata !"_ZN7_ap_sc_5sc_dt7sc_uintILi32EEC1Ej", metadata !11, i32 298, metadata !1392, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!1508 = metadata !{i32 459009, metadata !1509, metadata !"op", metadata !143, i32 1372, metadata !199} ; [ DW_TAG_arg_variable ]
!1509 = metadata !{i32 458798, i32 0, metadata !594, metadata !"ap_int_base", metadata !"ap_int_base", metadata !"_ZN11ap_int_baseILi32ELb0EEC2Ej", metadata !143, i32 1372, metadata !640, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!1510 = metadata !{i32 462849, metadata !1511, metadata !"temp.V", metadata !3, i32 179, metadata !1432} ; [ DW_TAG_auto_variable_field ]
!1511 = metadata !{i32 459008, metadata !1501, metadata !"temp", metadata !3, i32 179, metadata !1361} ; [ DW_TAG_auto_variable ]
!1512 = metadata !{i32 332, i32 0, metadata !1513, metadata !1505}
!1513 = metadata !{i32 458763, metadata !1428, i32 331, i32 0} ; [ DW_TAG_lexical_block ]
!1514 = metadata !{i32 184, i32 0, metadata !1501, metadata !1494}
!1515 = metadata !{i32 185, i32 0, metadata !1501, metadata !1494}
!1516 = metadata !{i32 462849, metadata !1517, metadata !"v.V", metadata !12, i32 98, metadata !1108} ; [ DW_TAG_auto_variable_field ]
!1517 = metadata !{i32 459008, metadata !1211, metadata !"v", metadata !12, i32 98, metadata !591} ; [ DW_TAG_auto_variable ]
!1518 = metadata !{i32 98, i32 0, metadata !1211, metadata !1519}
!1519 = metadata !{i32 300, i32 0, metadata !996, metadata !1520}
!1520 = metadata !{i32 187, i32 0, metadata !1501, metadata !1494}
!1521 = metadata !{i32 20, i32 0, metadata !1208, metadata !1522}
!1522 = metadata !{i32 99, i32 0, metadata !1211, metadata !1519}
!1523 = metadata !{i32 20, i32 0, metadata !1184, metadata !1524}
!1524 = metadata !{i32 99, i32 0, metadata !1187, metadata !1525}
!1525 = metadata !{i32 300, i32 0, metadata !506, metadata !1526}
!1526 = metadata !{i32 188, i32 0, metadata !1501, metadata !1494}
!1527 = metadata !{i32 705, i32 0, metadata !1219, metadata !1526}
!1528 = metadata !{i32 20, i32 0, metadata !1208, metadata !1529}
!1529 = metadata !{i32 99, i32 0, metadata !1211, metadata !1530}
!1530 = metadata !{i32 300, i32 0, metadata !996, metadata !1526}
!1531 = metadata !{i32 459008, metadata !1492, metadata !"i", metadata !3, i32 167, metadata !199} ; [ DW_TAG_auto_variable ]
!1532 = metadata !{i32 174, i32 0, metadata !1492, metadata !1494}
!1533 = metadata !{i32 459009, metadata !1302, metadata !"ptData32", metadata !3, i32 163, metadata !1305} ; [ DW_TAG_arg_variable ]
!1534 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.nResetPort.m_if.Val", metadata !3, i32 22, metadata !1141} ; [ DW_TAG_arg_variable_field ]
!1535 = metadata !{i32 459009, metadata !1536, metadata !"this", metadata !3, i32 22, metadata !1139} ; [ DW_TAG_arg_variable ]
!1536 = metadata !{i32 458798, i32 0, metadata !4, metadata !"matrix_mul", metadata !"matrix_mul", metadata !"_ZN10matrix_mulC1EN7_ap_sc_7sc_core14sc_module_nameE", metadata !3, i32 22, metadata !1024, i1 false, i1 true, i32 0, i32 0, null, i1 false} ; [ DW_TAG_subprogram ]
!1537 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.ClockPort.m_if.Val", metadata !3, i32 22, metadata !1141} ; [ DW_TAG_arg_variable_field ]
!1538 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.ReadEnablePort_0.m_if.Val.V", metadata !3, i32 22, metadata !1144} ; [ DW_TAG_arg_variable_field ]
!1539 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.ReadEmptyPort_0.m_if.Val.V", metadata !3, i32 22, metadata !1146} ; [ DW_TAG_arg_variable_field ]
!1540 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.ReadDataPort_0.m_if.Val.V", metadata !3, i32 22, metadata !1148} ; [ DW_TAG_arg_variable_field ]
!1541 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.WriteEnablePort_0.m_if.Val.V", metadata !3, i32 22, metadata !1144} ; [ DW_TAG_arg_variable_field ]
!1542 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.WriteFullPort_0.m_if.Val.V", metadata !3, i32 22, metadata !1146} ; [ DW_TAG_arg_variable_field ]
!1543 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.WriteDataPort_0.m_if.Val.V", metadata !3, i32 22, metadata !1152} ; [ DW_TAG_arg_variable_field ]
!1544 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.m_result", metadata !3, i32 22, metadata !1154} ; [ DW_TAG_arg_variable_field ]
!1545 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.m_operand1", metadata !3, i32 22, metadata !1156} ; [ DW_TAG_arg_variable_field ]
!1546 = metadata !{i32 462851, metadata !1535, metadata !"matrix_mul.m_operand2", metadata !3, i32 22, metadata !1158} ; [ DW_TAG_arg_variable_field ]
!1547 = metadata !{i32 24, i32 0, metadata !1548, null}
!1548 = metadata !{i32 458763, metadata !1549, i32 22, i32 0} ; [ DW_TAG_lexical_block ]
!1549 = metadata !{i32 458763, metadata !1536, i32 22, i32 0} ; [ DW_TAG_lexical_block ]
!1550 = metadata !{i32 25, i32 0, metadata !1548, null}
!1551 = metadata !{i32 26, i32 0, metadata !1548, null}
!1552 = metadata !{i32 27, i32 0, metadata !1548, null}
!1553 = metadata !{i32 28, i32 0, metadata !1548, null}
!1554 = metadata !{i32 29, i32 0, metadata !1548, null}
!1555 = metadata !{i32 30, i32 0, metadata !1548, null}
!1556 = metadata !{i32 31, i32 0, metadata !1548, null}
!1557 = metadata !{i32 32, i32 0, metadata !1548, null}
!1558 = metadata !{i32 33, i32 0, metadata !1548, null}
!1559 = metadata !{i32 34, i32 0, metadata !1548, null}
!1560 = metadata !{i32 35, i32 0, metadata !1548, null}
